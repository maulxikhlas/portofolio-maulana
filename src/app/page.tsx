  ...
  return (
    <main id="portfolio-content" className="min-h-screen bg-slate-950 text-slate-300 font-sans p-8 md:p-20">
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        {/* --- HEADER --- */}
        <header className="flex flex-col md:flex-row gap-6 border-b border-slate-800 pb-8 items-center md:items-start">
          {/* Foto Profil */}
          <div className="flex-shrink-0">
            <img
              src="/foto-lu.PNG" // Pastikan file foto lu ada di folder public/ dengan nama ini
              alt="M Maulana Ikhlas"
              className="w-32 h-32 md:w-40 md:h-40 rounded-2xl object-cover border-2 border-slate-800"
            />
          </div>
